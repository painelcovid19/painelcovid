...
s3_directory_path = "s3://painelcovid/data"

df_cidades_campi = read_data("df_cidades_campi.csv", "oci")
df_mapas = read_data("df_dados_acumulados.csv", "oci")
df_atualizacao = read_data("last_update_dates.csv", "oci")
